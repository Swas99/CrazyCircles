...
import com.archer.crazy_circle_games.survival_circle.game_logic.SinglePlayerGame;
...
//        colorAnimation.start();
    ...
    private void load_single_player_game() {
        ...
        view_to_load = inflater.inflate(R.layout.sc_view_single_player_game, Root, false);
    ...
    public void load_settings_screen()
    {
        ...
        view_to_load = inflater.inflate(R.layout.sc_view_settings, Root, false);
    ...
    public void load_animated_home_screen()
    {
        View view_to_load;
        LayoutInflater inflater = mContext.getLayoutInflater();
        view_to_load = inflater.inflate(R.layout.sc_activity_main, null, false);
        mContext.setContentView(view_to_load);
        Root = (ViewGroup)mContext.findViewById(R.id.Root);
        Root.setBackgroundResource(All_Background_Res[Background_Index]);

        view_to_load = inflater.inflate(R.layout.sc_view_home, Root, false);
...
//            }
    ...
    private void gotoHome_SlideRight()
    {
        ...
        LayoutInflater inflater = mContext.getLayoutInflater();
        View view_to_load = inflater.inflate(R.layout.sc_view_home, Root, false);
        Root.addView(view_to_load.findViewById(R.id.home_screen));
