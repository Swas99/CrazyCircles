...
import com.archer.crazy_circle_games.survival_circle_2.game_logic.SinglePlayerGame;
...
//        colorAnimation.start();
            ...
            public void onClick(View v) {
                ...
                switch (v.getId())
                {
                    ...
                    case R.id.btn_leader_board:
                        ...
                        mContext.objGameServices.onShowLeaderBoardRequested(mContext.getString(R.string.leaderboard_top_score__sc_2));
                        break;
                    ...
                    case R.id.btn_share:
                    {
                        ...
                        String msg = "Beat my score of " + mContext.BestScore +
                                ...
                                "https://play.google.com/store/apps/details?id=com.archer.crazy_circle_games.survival_circle_2";
    ...
    private void load_single_player_game() {
        ...
        view_to_load = inflater.inflate(R.layout.sc2_view_single_player_game, Root, false);
    ...
    public void load_settings_screen()
    {
        ...
        view_to_load = inflater.inflate(R.layout.sc2_view_settings, Root, false);
    ...
    public void load_animated_home_screen()
    {
        View view_to_load;
        LayoutInflater inflater = mContext.getLayoutInflater();
        view_to_load = inflater.inflate(R.layout.sc2_activity_main, null, false);
        mContext.setContentView(view_to_load);
        Root = (ViewGroup)mContext.findViewById(R.id.Root);
        Root.setBackgroundResource(All_Background_Res[Background_Index]);

        view_to_load = inflater.inflate(R.layout.sc2_view_home, Root, false);
...
//            }
    ...
    private void gotoHome_SlideRight()
    {
        ...
        LayoutInflater inflater = mContext.getLayoutInflater();
        View view_to_load = inflater.inflate(R.layout.sc2_view_home, Root, false);
        Root.addView(view_to_load.findViewById(R.id.home_screen));
