package com.archer.crazy_circle_games.survival_circle_2.game_logic;
...
import com.archer.crazy_circle_games.survival_circle_2.Helper;
...
public class DynamicTokens {
    ...
    class PlusOneToken
    {
        ...
        {
            final View tokenView = getTokenView(R.drawable.background_blue_circle_2,"1");
    ...
    class PlusTwoToken
    {
        ...
        {
            final View tokenView = getTokenView(R.drawable.background_red_circle_3,"2");
            mainContainer.addView(tokenView);
            activeTokens.add(tokenView);
    ...
    class PlusThreeToken
    {
        ...
        {
            final View tokenView = getTokenView(R.drawable.background_black_circle_3,"3");
            mainContainer.addView(tokenView);
            activeTokens.add(tokenView);
    ...
    class MinusOneToken
    {
        ...
        {
            final View tokenView = getTokenView(R.drawable.background_blue_square_2,"-1");
            mainContainer.addView(tokenView);
            activeTokens.add(tokenView);
